     ...
     <table class="w-full" striped>
        ...
        <tbody>
            <tr v-for="(row, index) in data" :key="index" class="border-b border-gray-200 dark:border-gray-700">
                <th scope="row" class="font-semibold text-gray-800 dark:text-gray-400 px-6 py-4 text-left">{{ row.WellName }}</th>
                <td class="font-normal text-gray-800 dark:text-gray-400 px-6 py-4 text-left border-l border-gray-200 dark:border-gray-700">{{ row.Date }}</td>
                <td class="px-6 py-4 text-left text-gray-800 dark:text-gray-400 border-l border-gray-200 dark:border-gray-700">{{ row.RegDescript }}</td>
                <td class="px-6 py-4 text-left border-l border-gray-200 dark:border-gray-700">
                    ...
                    <span v-else class="py-1 px-2 bg-red-100 text-red-600 dark:bg-red-500 dark:text-white dark: rounded-3xl">Нет</span>
                </td>
            </tr>
        </tbody>
    </table>   
