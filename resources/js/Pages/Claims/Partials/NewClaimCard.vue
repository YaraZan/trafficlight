<template>
    <div class="group bg-gray-50 flex flex-col gap-2 items-center justify-center rounded-md
     border-2 border-dashed border-gray-300 hover:border-green-400 cursor-pointer
     dark:bg-gray-900 dark:border-gray-700 dark:hover:border-green-400">
