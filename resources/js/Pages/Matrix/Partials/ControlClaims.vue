...
<template>
    <div class="w-full flex flex-col p-4 gap-4">
        ...
        <div class="flex items-center justify-between">
            ...
            <span class="text-gray-800 dark:text-white text-[18px] font-semibold">Заявки</span>
        ...
        <div class="grid grid-cols-4 gap-[5px]">
            <div v-for="(claim, index) in paginatedData"
                 :key="index"
                 class="group bg-gray-100 dark:bg-gray-900 rounded-lg flex flex-col justify-between p-5
                 h-[200px] relative">
                ...
                <span class="max-w-[150px] text-[16px] text-gray-800 dark:text-white font-semibold">{{ claim.Comment }}</span>

                <span class="text-gray-400 font-normal text-[14px]">{{ claim.Dat }}</span>
            </div>
