    ...
    <table id="exportMatrix" class="w-full border-separate border-spacing-0">
        ...
        <tr class="border bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700">
            <th rowspan="2" class="items-center px-4 py-1 text-left">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">Связь</span>
            </th>
            <th rowspan="2" class="items-center px-4 py-1 text-left border-gray-200 dark:border-gray-700 border-l">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">НГДУ</span>
            </th>
            <th rowspan="2" class="items-center px-4 py-1 text-left border-gray-200 dark:border-gray-700 border-l">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">Цех</span>
            </th>
            <th rowspan="2" class="items-center px-4 py-1 text-left border-gray-200 dark:border-gray-700 border-l">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">Скважина</span>
            </th>
            <th rowspan="2" class="items-center px-4 py-1 text-left border-gray-200 dark:border-gray-700 border-l">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">Состояние</span>
            </th>
            <th rowspan="2" class="items-center px-4 py-1 text-left border-gray-200 dark:border-gray-700 border-l">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">Дата</span>
            </th>
            <th rowspan="2" class="items-center px-4 py-1 text-center border-gray-200 dark:border-gray-700 border-l">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">Штраф</span>
            </th>
            <th rowspan="2" class="items-center px-4 py-1 text-center border-gray-200 dark:border-gray-700 border-l">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">Опрос</span>
            </th>
            <th colspan="4" class="items-center px-4 py-1 text-center border-gray-200 dark:border-gray-700 border-l border-b">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">Число качаний, об/мин</span>
            </th>
            <th colspan="4" class="items-center px-4 py-1 text-center border-gray-200 dark:border-gray-700 border-l border-b">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">Длина хода</span>
            </th>
            <th colspan="3" class="items-center px-4 py-1 text-center border-gray-200 dark:border-gray-700 border-l border-b">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">Нагрузка максимальная, кг</span>
            </th>
            <th colspan="3" class="items-center px-4 py-1 text-center border-gray-200 dark:border-gray-700 border-l border-b">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">Нагрузка минимальная, кг</span>
            </th>
            <th colspan="3" class="items-center px-4 py-1 text-center border-gray-200 dark:border-gray-700 border-l border-b">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">Температура масла в ГБ, °С</span>
            </th>
            <th colspan="3" class="items-center px-4 py-1 text-center border-gray-200 dark:border-gray-700 border-l border-b">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">Давление в ГН , МПа</span>
            </th>
            <th colspan="3" class="items-center px-4 py-1 text-center border-gray-200 dark:border-gray-700 border-l border-b">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">Давление в ГЦ , МПа</span>
            </th>
            <th colspan="3" class="items-center px-4 py-1 text-center border-gray-200 dark:border-gray-700 border-l border-b">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">Давление в ПГА, МПа</span>
            </th>
            <th colspan="3" class="items-center px-4 py-1 text-center border-gray-200 dark:border-gray-700 border-l border-b">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">Ток, А</span>
            </th>
            <th colspan="3" class="items-center px-4 py-1 text-center border-gray-200 dark:border-gray-700 border-l border-b">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">Напряжение, В</span>
            </th>
        </tr>
        <tr class="border-y bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700">
            <th class="items-center px-4 py-1 text-left border-gray-200 dark:border-gray-700 border-l">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">АРМИТС</span>
            </th>
            <th class="items-center px-4 py-1 text-left border-gray-200 dark:border-gray-700 border-l">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">Уставка</span>
            </th>
            <th class="items-center px-4 py-1 text-left border-gray-200 dark:border-gray-700 border-l">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">Факт</span>
            </th>
            <th class="items-center px-4 py-1 text-left border-gray-200 dark:border-gray-700 border-l">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">Отклонение</span>
            </th>
            <th class="items-center px-4 py-1 text-left border-gray-200 dark:border-gray-700 border-l">
                <span class="text text-[14px] font-semibold text-gray-800 dark:text-gray-300">АРМИТС</span>
            </th>
