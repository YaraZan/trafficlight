    ...
    <table class="w-full" striped>
        <thead>
            <tr class="border-y bg-gray-50 dark:bg-gray-900 dark:bg-opacity-40 border-gray-200 dark:border-gray-700">
                ...
                <th scope="col" class="items-center px-4 py-3 text-center border-gray-200 dark:border-gray-700 border-l">
        ...
        <tbody>
            <tr v-for="(row, index) in data" :key="index"  class="hover:bg-gray-50 dark:hover:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
                ...
                <td class="font-bold px-4 py-3 text-center border-l border-gray-200 dark:border-gray-700 text-gray-800 dark:text-gray-400">{{ extractNgdu(row.WellName) }}</td>
                <td class="px-4 py-3 text-center  border-l border-gray-200 dark:border-gray-700 text-gray-800 dark:text-gray-400">{{ extractNumericPart(row.ShopName) }}</td>
                <td class="px-4 py-3 text-center border-l border-gray-200 dark:border-gray-700 text-gray-800 dark:text-gray-400">{{ extractWellNumber(row.WellName) }}</td>
                <td class="px-4 py-3 text-left border-l border-gray-200 dark:border-gray-700 text-gray-800 dark:text-gray-400">{{ row.WellState }}</td>
                <td class="px-4 py-3 text-left border-l border-gray-200 dark:border-gray-700 text-gray-800 dark:text-gray-400">{{ row.Date }}</td>
                <td class="px-4 py-3 text-center border-l border-gray-200 dark:border-gray-700 text-gray-800 dark:text-gray-400">{{ row.SumErr ? row.SumErr : '-' }}</td>
                <td class="px-4 py-3 text-center border-l border-gray-200 dark:border-gray-700 text-gray-800 dark:text-gray-400">
                    <span v-if="row.Ask" class="py-1 px-2 bg-green-100 text-green-600 dark:bg-green-500 dark:text-gray-300 dark:font-semibold rounded-3xl">Выполнен</span>
                    <span v-else class="py-1 px-2 bg-red-100 text-red-600 dark:bg-red-500 dark:text-gray-300 dark:font-semibold rounded-3xl">Нет</span>
                </td>
